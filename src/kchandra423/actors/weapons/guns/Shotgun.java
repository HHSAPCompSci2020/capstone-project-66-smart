...
//        super(AssetLoader.getImage(AssetLoader.Sprite.SHOTGUN), 0.5f, (float)Math.PI/5, AssetLoader.Sprite.BULLET, 20f, stats, DamageTypes.RANGED, 6, 5);
        super(AssetLoader.getImage(AssetLoader.Sprite.SHOTGUN), 0.5f, (float) Math.PI / 6, new PiercingProjectile(AssetLoader.getImage(AssetLoader.Sprite.BULLET), 20f, 0, true, stats, DamageTypes.MAGIC, 5,2), 5);
    }
}
