...
public class MagicStaff extends Gun {
    ...
    public MagicStaff(float[] stats) {
        super(AssetLoader.getImage(AssetLoader.Sprite.MAGIC_STAFF), 0.3f, (float) Math.PI / 8, new PiercingProjectile(AssetLoader.getImage(AssetLoader.Sprite.MAGIC_BALL), 7f, 0, true, stats, DamageTypes.MAGIC, 15,5), 1);
    }
}
