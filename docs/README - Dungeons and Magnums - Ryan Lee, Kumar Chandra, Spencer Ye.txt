...
Introduction: 
Our program creates a graphical-based game where the user controls a character around a room and uses weapons to defeat computer-controlled enemies to progress through levels in order to complete the game.[a][b][c]
...
The rules of our game is that you must stay in the confines of the room, there are game mechanics that prevent you from leaving. Similarly, most other rules of the game are enforced through code, such as: players cannot move onto obstacles[e]. The goal of our game is to [f]complete all the levels to finish the program.
...
* Menu has a basic instruction manual, which just explains how to play the game. Should explain how to fight against enemies, how to progress through levels, Until they eventually finish or die.[i](DONE)
* Playable game - Users should be able to move, fire weapons[j], and collide with objects[k]. Players should also be able to move through and navigate each level, and progress onto the next one(DONE)
...
* Projectile
   * Projectile used by any form of a ranged RangedWeapon[n], has its own sprite, and determines if it comes into contact with an enemy or player, and whether they are killed or not
* Calculator
...
[a]Overall, your game sounds really fun! My only comment is that it is lacking uniqueness. What makes this game any different from any other game? Why should someone play your game?
[b]this is very similar to a lot of existing games. How does your game differentiate from all the other ones?
[c]This sounds like a fun game.
[d]Perhaps add a description of what Soul Knight is for those who do not know. And then describe your version of the game.
[e]I would assume moving onto obstacles means that players can also move up and down, so is your game in a 3D format?
[f]You could consider adding a few lines in the intro about how points are scored; I think you go into it later but it would be nice to know the overall objective in the beginning.
[g]these instructions are very clear!
[h]these features seem like they can be practically done in timeline
[i]Is the only end to the game when they die or finish all the levels?
[j]Are the weapons based on the different type of players?
[k]Does colliding with other players have different results than colliding with enemies?
[l]Are level/xp based on points?
[m]These classes make sense and the organization of your project looks good.
[n]Are these other classes for weapons?
[o]The work seems split pretty evenly